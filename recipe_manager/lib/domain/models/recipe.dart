...
class Recipe {
  ...
  /// FR-033: map of step index (0-based) -> local photo file path
  final Map<int, String> stepPhotos;
  ...
  factory Recipe.fromMap(Map<String, dynamic> map, {List<String>? tags, Map<int, String>? stepPhotos}) {
