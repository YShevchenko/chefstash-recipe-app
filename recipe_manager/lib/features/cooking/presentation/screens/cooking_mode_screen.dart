    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          // Instructions tab — FR-033: show step photos if present
          ListView.builder(
            padding: const EdgeInsets.all(24),
            ...
            itemBuilder: (context, index) {
              ...
              final photoPath = widget.recipe.stepPhotos[index];
                  ...
                  children: [
                    ...
                    if (photoPath != null) ...[
                      ...
                      Padding(
                        ...
                        child: _StepPhotoWidget(photoPath: photoPath),
                      ),
                    ],
                  ],
                ),
...
/// Displays a step photo with rounded corners.
/// Shows nothing if the file does not exist.
class _StepPhotoWidget extends StatelessWidget {
  final String photoPath;

  const _StepPhotoWidget({required this.photoPath});
